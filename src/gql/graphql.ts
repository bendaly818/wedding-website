...
export type Seating_Element = Node & {
  ...
  seat_assignmentCollection?: Maybe<Seat_AssignmentConnection>;
  seat_offsets?: Maybe<Array<Maybe<Scalars['Float']['output']>>>;
...
export type Seating_ElementFilter = {
  ...
  seat_offsets?: InputMaybe<FloatListFilter>;
...
export type Seating_ElementInsertInput = {
  ...
  seat_offsets?: InputMaybe<Array<InputMaybe<Scalars['Float']['input']>>>;
...
export type CreateSeatingElementMutation = { __typename?: 'Mutation', insertIntoseating_elementCollection?: { __typename?: 'seating_elementInsertResponse', records: Array<{ __typename?: 'seating_element', id: any, kind: string, label?: string | null, x: number, y: number, width: number, height: number, rotation: number, seats_top: number, seats_right: number, seats_bottom: number, seats_left: number, seat_offsets?: Array<number | null> | null }> } | null };
